...
const MailSideBar = ({ messages, mailIndexUpdated, index, toggleArchived, toggleArchivedFunc, searchChange }) => {
    return (
            ...
            <div className="br-mailbox-list-body">
                <div className="search">
                    <span className="searchWrap">
                        <TextInput onChange={searchChange} label="searchBar" placeHolder="Search" name="searchBar" type="text"></TextInput>
                    </span> 
                ...
                {messages.length > 0 ? messages.map( (msg, i) =>
                    <div key={msg.id}>
                        <MailItem
                            ...
                            productDescription={messages[i].productDescription}
                            propId={i}
                            mailIndexUpdated={mailIndexUpdated}
